...
import specFiles from '../specfiles.js';
...
export const config = {
  ...
  //
  // Api project uncomment and execute if not comment it
  ...
  //   "wdio-cli": "silent",
  //   "wdio-sauce-service": "silent",
  //   "wdio-utils": "silent",
  //   "wdio/mocha-framework": "silent",
  //   "wdio/config": "silent",
  //   "wdio/sumologic-reporter": "silent",
...
// hostname: "0.0.0.0",
  ...
  before: function (capabilities, specs) {
    //Defined the wrapper commands
    // Object.keys(commands).forEach((key) => {
    //   AllureReporter.addStep(browser.addCommand(key, commands[key]));
    // });
  ...
  //  const startMs = (this.startTime[0] * 1000) + (this.startTime[1] / 1000000);
  //  AllureReporter.addDescription(`Execution start time: ${startMs}ms`);
  ...
  onComplete: async function (exitCode, config, capabilities, results) {
    ...
    open("./reports/html-reports/master-report.html");
  },
  // }
